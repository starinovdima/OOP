...
namespace Laba3 {
    ...
    public:
        ...
        explicit Binary_signal(const double m_duration) : max_duration(m_duration){};
        ...
        void cleaning_all();
        friend Binary_signal & operator ~(Binary_signal &signal); // ~
        void add_signal_to_end(unsigned char symbol, double time);
        void add_signal(const Binary_signal &signal_two); // +/+=
